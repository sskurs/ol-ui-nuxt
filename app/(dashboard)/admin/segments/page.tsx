...
export default function SegmentsPage() {
  ...
  const [segments, setSegments] = useState<Segment[]>([
    {
      ...
      criteria: [
        { id: "1", field: "totalSpent", operator: ">=", value: "1000" },
        { id: "2", field: "transactionCount", operator: ">=", value: "10", logicalOperator: "AND" },
      ],
      memberCount: 245,
      status: "active",
    ...
    },
    {
      ...
      criteria: [
        { id: "1", field: "tier", operator: "=", value: "platinum" },
        { id: "2", field: "pointsEarned", operator: ">=", value: "5000", logicalOperator: "AND" },
      ],
      memberCount: 67,
      status: "draft",
  ...
  const handleCreateSegment = () => {
    ...
    const segment: Segment = {
      ...
      criteria: newSegment.criteria.filter((c) => c.field && c.operator && c.value),
    ...
    setNewSegment({
      name: "",
      description: "",
      criteria: [{ id: "1", field: "", operator: "", value: "", logicalOperator: undefined }],
      color: "#10B981",
    })
    ...
    setSegments(
      segments.map((segment) =>
        segment.id === selectedSegment.id
          ? { ...selectedSegment, lastUpdated: new Date().toISOString().split("T")[0] }
          : segment,
      ),
    )
