        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{levels.filter((l) => l.isActive).length} active</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {levels.reduce((sum, level) => sum + level.memberCount, 0).toLocaleString()}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {levels.sort((a, b) => b.pointsRequired - a.pointsRequired)[0]?.pointsRequired.toLocaleString()} points
                required
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(levels.reduce((sum, level) => sum + level.multiplier, 0) / levels.length).toFixed(1)}x
              </div>
