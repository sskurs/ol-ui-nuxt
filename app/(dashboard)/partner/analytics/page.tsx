...
export default function AnalyticsPage() {
  ...
  const mockAnalytics = {
    overview: {
      ...
      rewardRedemptionRate: 36.0,
    },
    trends: {
      customerGrowth: 12.5,
      pointsGrowthRate: 8.3,
      revenueGrowth: 15.2,
      redemptionGrowth: 22.1,
    },
    topRewards: [
      { name: "10% Store Discount", redemptions: 125, revenue: 2500 },
      { name: "Free Coffee", redemptions: 89, revenue: 890 },
      { name: "Free Shipping", redemptions: 67, revenue: 670 },
      { name: "VIP Event Access", redemptions: 12, revenue: 1200 },
    ],
    customerSegments: [
      { tier: "Platinum", count: 45, percentage: 3.6, avgSpend: 125.5 },
      { tier: "Gold", count: 156, percentage: 12.5, avgSpend: 85.25 },
      { tier: "Silver", count: 389, percentage: 31.1, avgSpend: 55.75 },
      { tier: "Bronze", count: 660, percentage: 52.8, avgSpend: 32.4 },
    ],
    monthlyData: [
      { month: "Jan", customers: 1100, points: 98000, revenue: 18500 },
      { month: "Feb", customers: 1150, points: 105000, revenue: 21200 },
      { month: "Mar", customers: 1200, points: 115000, revenue: 23800 },
      { month: "Apr", customers: 1250, points: 125000, revenue: 25000 },
    ],
    goals: [
      { name: "Monthly Revenue", current: 25000, target: 30000, percentage: 83.3 },
      { name: "New Customers", current: 50, target: 75, percentage: 66.7 },
      { name: "Points Issued", current: 125000, target: 150000, percentage: 83.3 },
      { name: "Redemption Rate", current: 36, target: 40, percentage: 90.0 },
    ],
  }
